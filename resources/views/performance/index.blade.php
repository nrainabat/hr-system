...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold" style="color: #0f172a;">Performance Evaluations</h2>
        
        {{-- Only show 'New Evaluation' if user has subordinates --}}
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center py-5 text-muted">No evaluations found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
