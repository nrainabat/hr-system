               ...
               <div class="card-body d-flex flex-column align-items-center justify-content-center text-center py-4"> 
                    ...
                    <div class="mb-3">
                        <h5 class="fw-bold mb-2">
                            Status: 
                            {{-- LOGIC: Show 'Not Clocked In' if no record OR if the last shift is finished --}}
                        ...
                        <div class="text-muted fs-5">
                            @if($todayAttendance)
                                ...
                                {{-- Show 'Out' time only if it exists --}}
                    ...
                    <div>
                        {{-- STATE A: Show CLOCK IN if no record OR last record is finished --}}
                        @if(!$todayAttendance || $todayAttendance->clock_out)
                        ...
                        {{-- STATE B: Show CLOCK OUT if currently working --}}
                        @else
    ...
    <div class="card mb-4 shadow-sm border-0">
        ...
        <div class="card-body">
            <div class="row g-3 text-center text-white">
                ...
                <div class="col-md-3">
                    <div class="p-4 rounded shadow-sm" style="background-color: #0d6efd;">
                        <h5 class="fw-bold mb-1">Total Applied</h5>
